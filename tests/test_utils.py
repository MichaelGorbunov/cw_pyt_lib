import pytest
from src.utils import get_response, select_data, get_data_group_by_card, get_top_transact
import pandas as pd
import os
...
def test_get_data_group_by_card():
    ...
    assert result == [{'cashback': 214.11, 'last_digits': '*4556', 'total_spent': 21411.4},
